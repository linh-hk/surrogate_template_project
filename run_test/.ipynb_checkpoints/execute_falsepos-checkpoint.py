...
if __name__=="__main__":
    ...
    data = data[N0 : N0 + batch_N] # move to below check_streamed
    ...
    if os.path.isfile(fiS):
        CONTINUE, done_ids = check_streamed(fiS, N0=N0, batch_N=batch_N, saveP=saveP)
    if not CONTINUE and not done_ids:
    ...
    for series, series_id in data:
        if series_id in done_ids:           # skip finished, keep partners intact
          continue
